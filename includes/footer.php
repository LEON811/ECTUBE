...
<footer class="container col-12 p-5 bg-dark text-secondary mb-0">
    <div class="row">
      <div class="col-12 col-md justify-content-center">
        <img src="./images/leonstree.png" alt="mian_logo" style="width:200px; margin-top: -10px; margin-bottom: 10px;">
        <small class="d-block mb-1 text-muted">&copy; LEONS TREE </small>
      </div>
      <div class="col-3 col-md ">
        <h5>Contact</h5>
        <ul class="list-unstyled text-small">
          <small>〒xxx-xxxx<br>xxxxxxxx<br>xxxxxxxx</small><br>
          <small><i class="fa fa-phone"></i> XXーXXXXーXXXX</small><br>
		      <small><i class="fa fa-envelope"></i> Email: <a href="#">leonstree@gmail.com</a></small>
        </ul>
      </div>
