<?php
    ...
    { 
        ...
        $dsn = "mysql:host = localhost;dbname=db_kdk;charset=utf8mb4";
        //※data source name
        //127.0.0.1=localhost
    ...
    try{
        ...
        //LIVE_TITLE ゲット
        $sql = "select l.user_id, l.title, l.description, u.user_name, u.user_icon,l.live_key from live l JOIN user u ON l.user_id = u.user_id where l.live_id = $live_id";
        $dbh = $pdo->query($sql);
