...
<section class="m-5 px-5">
	<div class="row">
		<div class="col-md-6 mb-4 "  id ="product_detail">	
			 <?php echo img_tag($goods['image_id']) ?>  <!-- db_connect.php -->
		...
		<div class="col-md-6" >
			...
			<table class="table table-sm table-borderless ">
				...
				<tr>
					<th class="pl-0 w-25" scope="row"><strong>メーカー</strong></th>
					<td><?php echo $goods['product_maker'] ?></td>
				</tr>
				<tr>
