...
--
-- テーブルのAUTO_INCREMENT `access_logs`
--
ALTER TABLE `access_logs`
...
--
-- テーブルのAUTO_INCREMENT `product_report`
--
ALTER TABLE `product_report`
...
--
-- テーブルのAUTO_INCREMENT `vedio_report`
--
ALTER TABLE `vedio_report`
  MODIFY `vedio_report_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- テーブルのAUTO_INCREMENT `video`
--
ALTER TABLE `video`
...
ALTER TABLE `delete_record`
  ...
  ADD CONSTRAINT `delete_record_ibfk_5` FOREIGN KEY (`vedio_report_id`) REFERENCES `vedio_report` (`vedio_report_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
-- テーブルの制約 `vedio_report`
--
ALTER TABLE `vedio_report`
  ADD CONSTRAINT `vedio_report_ibfk_1` FOREIGN KEY (`report_id`) REFERENCES `report_category` (`report_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `vedio_report_ibfk_2` FOREIGN KEY (`reporter_id`) REFERENCES `user` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `vedio_report_ibfk_3` FOREIGN KEY (`video_id`) REFERENCES `video` (`video_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
