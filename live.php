...
<div class="row" >
  <!-- ライブ -->
    <div class="col-md-8">
      <div class="live_area pl-2 ml-3">
          <video id = "live"  class="video-js ml-4" controls autoplay
          preload="auto"  data-setup='{}' techOrder="[ 'html5','flash']">
          <source src="./hls/<?php echo $live_key;?>.m3u8" type="application/x-mpegURL">
          </video>
      </div>
