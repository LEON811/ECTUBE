...
<html lang="jp">
  ...
  <body class="text-center">
    ...
    <a href="index.php"><img class="mb-4" src="files/leonstree.png" alt="logo" width="150" height="40"></a>
    ...
    <a href="index.php" class="btn btn-link btn-sm btn-block" >トップページへ</a>
    <p class="mt-5 mb-3 text-muted">&copy; LEONS TREE </p>
</form>
</body>
</html>
