...
<?php include("./includes/navbar.php");?>
  ...
  <main role="main">
    ...
    <div class="slider">
      <img src="./images/slide/slide_4.png">
  ...
  <div class="container">
    ...
    <?php foreach ($goods as $g) {
      ...
      <div class="col-3">
        <div class="card mb-3 shadow-sm" style="height: 580px">
            <img id = "product_img" src="<?php echo $g['image_id'];?>" alt="procust_img" class="img-fluid pt-3">
    ...
    <div class="row">
      <div>
        <a id="back-to-top" href="#" class="btn btn-light back-to-top btn-lg mr-5 my-3 float-right" role="button"><i class="fa fa-chevron-up"></i></a>
      </div>
    </div>
  </div>
