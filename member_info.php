...
<main class="my-4 mx-5">
    ...
    <div class="row mt-4">
        <div class="text-center">
            <img style = "height: 100px; width:100;" class="rounded-circle border shadow-sm" src="" alt="user_icon" id = "user_img">
...
​
        ...
        <div class="sent mb-4">
            ...
            <a href="mypage" class="btn btn-secondary float-right mr-3">戻る</a>
        </div>         
    </form>
